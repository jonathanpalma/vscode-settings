...
- [Flow Language Support](https://github.com/flowtype/flow-for-vscode)
- [gi](https://github.com/hasit/vscode-gi)
- [Git History](https://github.com/DonJayamanne/gitHistoryVSCode)
- [GitLens — Git supercharged](https://github.com/eamodio/vscode-gitlens)
- [HTML Snippets](https://marketplace.visualstudio.com/items?itemName=abusaidm.html-snippets)
- [Import Cost](https://github.com/wix/import-cost)
- [Kanban](https://github.com/mkloubert/vscode-kanban)
...
### Theme
- [One Dark Pro](https://github.com/ChristianKohler/NpmIntellisense)
